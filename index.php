        ...
        <?php foreach ($books as $b): ?>
            ...
            <div class="book-card">
                ...
                <div class="book-cover">
                    <div class="title">
                        <!-- teks judul dan tahun terbitnya -->
                        <div class="cover-title"><?= $b['judul']; ?></div>
                        <div class="cover-sub"><?= $b['tahun_terbit']; ?></div>
                    </div>
                </div>

                <!-- info judul dan penulis -->
                <div class="book-info">
                ...
                <!-- tombol detail (SVG) -->
                <div class="btn-book">
                    <a title="Lihat Rincian Buku" class="detail-link" href="<?= BASE_URL; ?>pemustaka/detail_buku.php?id=<?= $b['id_buku']; ?>" aria-label="Lihat detail">
